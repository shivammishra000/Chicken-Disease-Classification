...
from chickenDiseaseClassification.pipeline.stage_03_model_trainer import ModelTrainingPipeline
from chickenDiseaseClassification.pipeline.stage_04_model_evaluation import EvaluationPipeline
